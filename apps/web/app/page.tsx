  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto space-y-8 pb-12">
        {/* Page Header with Multi-Tenant Switcher */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-6">
          <div>
            ...
            <p className="text-xs text-white/50 mt-1">
              Active Organization: <span className="text-white font-medium">{orgName}</span> • Role: <span className="text-emerald-400 font-mono font-medium">{activeRole || "Super Admin"}</span>
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card variant="glass">
            <CardHeader>
              <CardTitle>Phase 07 Multi-Tenancy Verified</CardTitle>
              <CardDescription>Organizational boundaries, teams, and memberships operational</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 flex items-start space-x-3">
                ...
                <div className="space-y-1 text-xs">
                  <p className="font-semibold text-emerald-300">Phase 07 Multi-Tenancy Model Complete</p>
                  <p className="text-emerald-400/80 leading-relaxed">
                    Organizations, memberships, teams, invitations, and transactional creation functions established with full RLS test coverage.
                  </p>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5 flex items-center justify-between text-xs text-white/50">
                ...
                <span className="text-white font-medium">Phase 08 — RBAC & Permissions Engine</span>
              </div>
            </CardContent>
          </Card>
        </div>
